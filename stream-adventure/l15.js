...
const gunzipStream = require('zlib').createGunzip();
const cypherStream = crypto.createDecipher(process.argv[2], process.argv[3]);

parser.on('entry', function (e) {
  const md5Stream = crypto.createHash('md5', { encoding: 'hex' });
